...
const { data: category } = await useFetch<any>(`/api/community/categories/${slug.value}`, {
  default: () => ({
...
const { data: threads } = await useFetch(`/api/community/topics?category=${slug.value}`, {
  default: () => [
    {
      id: '1',
    ...
    <section class="p-8 rounded-3xl bg-neutral-100/50 dark:bg-neutral-900/50 border border-neutral-200 dark:border-neutral-800 relative overflow-hidden">
       ...
       <div class="relative z-10 flex items-center gap-6">
          ...
          <div class="hidden md:flex gap-2">
             ...
             <UButton to="/community/new" label="Nouvelle Question" icon="i-lucide-plus" size="sm" variant="solid" />
          </div>
       </div>
    </section>
